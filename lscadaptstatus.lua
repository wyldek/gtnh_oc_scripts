...
local function drawStatic()
  ...
  drawBox(1, 14, W, H - 14, " AE2 CRAFTING CPUS ", C.purple)
  drawStaticText(3, 16, "CPUs:", C.dim)
  drawStaticText(18, 16, "Busy:", C.dim)
  drawStaticText(35, 16, "Idle:", C.dim)

  drawStaticText(3, 18, " #  STAT   TIME     JOB / CPU", C.dim)
  drawStaticText(3, 19, string.rep("-", math.min(W - 6, 78)), C.dim)
end
...
local function updateCpus()
  ...
  writeField(10, 16, 5, tostring(#cpuList), C.fg)
  writeField(25, 16, 5, tostring(busyCount), busyCount > 0 and C.yellow or C.green)
  writeField(41, 16, 5, tostring(#cpuList - busyCount), C.green)
